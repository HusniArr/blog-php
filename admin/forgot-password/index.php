...
<body class="fp-page">
        ...
        <div class="card">
            <div class="body">
                <form id="forgot_password" method="POST">
                    ...
                    <button class="btn btn-block btn-lg bg-teal waves-effect" type="submit">RESET MY PASSWORD</button>
    ...
    <script src="<?php echo BASE_URL ?>admin/js/pages/examples/forgot-password.js"></script>
</body>
